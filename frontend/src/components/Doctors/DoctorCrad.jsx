    ...
    return (
        ...
        text-headingColor font-[700] mt-3 lg:mt-5">
            ...
            <div className='mt-2 lg:mt-4 flex items-center justify-between'>
                <span className='bg-[#CCF0F3] text-irisBlueColor py-1 lg:py-2 lg:px-6
                    text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded'>{specialization}
                </span>

                <div className="flex items-center gap-[6px]">
                    <span className='flex flex-center gap-[6px] text-[14px] leading-6 lg:text-[16px]
            ...
            text-decoration'>{totalRating}</span>
                </div>
            </div>
