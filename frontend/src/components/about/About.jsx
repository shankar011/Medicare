    ...
    <div className="container">
        <div className='flex justify-between gap-[50px] lg:gap-[130px] xl:gap-0 flex-col lg:flex-row'>
         ...
         <div className="w-full lg:w-1/2 xl:w-[670px] order-1 lg:order-2">
            ...
            Mumbai. Lorem ipsum dolor sit amet consectetur, adipisicing elit.
            Quas, nemo?
            </p>
            <p className="text_para mt-[30px]">Our best is something we strive for each day, caring for our
             ...
             we can do tomorrow. Providing the best. Lorem ipsum dolo
             amet, consectetur adipisicing 5600000 elit. Aliquid, modi?
            </p>
