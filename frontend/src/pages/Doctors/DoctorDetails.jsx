      ...
      <div className='grid md:grid-cols-3 gap-[50px]'>
          <div className='md:col-span-2'>
              ...
              <div>
                ...
                lg:px-6 text-[12px] leading-4 lg:text-[16px] lg:leading-7 font-semibold rounded'>Surgaon</span>
                <h3 className='text-headingColor text-[22px] leading-9 mt-5 font-bold'>Muhubur Rahman</h3>
