    ...
    <>
            ...
            <div>
              <div className='lg:w-[570px]'>
                ...
                <p className='text_para'>
                  ...
                  Explicabo nesciunt temporibus est. Quae quibusdam aut hic natus!
                  Non laboriosam, voluptate amet saepe, reiciendis laudantium nam ad illo,
                  placeat minima eligendi.
                </p>
      ...
      <section>
        <div className="conatiner">
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-03 gap-5 lg:gap-[30px] 
          mt-[30px] lg:mt-[55px]'>

            <div className='py-[30px] px-5'>
              <div className='flex items-center justify-center'> <img src={icon1} alt='' /></div>
            </div>
            ...
            <div className='py-[30px] px-5'>
              <div className='flex items-center justify-center'> <img src={icon2} alt='' /></div>
            </div>
            ...
            <div className='py-[30px] px-5'>
              <div className='flex items-center justify-center'> <img src={icon3} alt='' /></div>
            </div>

            <div className='mt-[30px]'>
              <h2 className='text-[26px] leading-9 text-headingColor font-[700] text-center'> Bool Appointment</h2>
              <p className='text-[16px] leading-7 text-textColor font-[400] mt-4 text-center'>
                World-class care for everyone. Our health System offers unmatched, expert health care.
                From the Tab to the clinic.
              </p>
        ...
        <div className="container">
          <div className='flex items-center justify-between flex-col lg:flex-row'>
            ...
            <div className='xl:w-[670px]'>
              <h2 className='heading'>Get Virtual <br /> Treatment</h2>
              <ul className='pl-4'>
              ...
              <Link to="/"><button className='btn'>Leran more</button> </Link>
            </div>
            ...
            <div className='relative z-10 xl:w-[770] flex justify-end mt-[50px] lg:mt-0'>
              ...
              <div className='w-[150px] lg:w-[200px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px]
                ...
                <div className='w-[65px] lg:w-[96px] bg-[#CCF0F3] py-1 px-2 lg:py-[6px]
                      text-[8] leading-[8px] lg:text-[12px] lg:leading-4 text-irisBlueColor
        ...
        <div className="container">
          <div className="xl:w-[470px] mx-auto">
            ...
            <p className="text_para text-center">
              World-class care for everyone. Our health sysytem unmatched, expert health care
            </p>
